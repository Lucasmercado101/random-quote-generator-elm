...
var _srcMainElm = require("./src/Main.elm");
const app = _srcMainElm.Elm.Main.init({
...
},{"./src/Main.elm":"dQUqP"}],"dQUqP":[function(require,module,exports) {
(function(scope){
'use strict';
...
var $author$project$Main$SingleQuote = function (a) {
	return {$: 'SingleQuote', a: a};
};
var $author$project$Main$GotRandomQuote = function (a) {
	return {$: 'GotRandomQuote', a: a};
};
...
var $author$project$Main$QuoteResp = F3(
	function (quoteText, quoteAuthor, quoteGenre) {
		return {quoteAuthor: quoteAuthor, quoteGenre: quoteGenre, quoteText: quoteText};
	});
var $author$project$Main$quoteDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$QuoteResp,
	A2($elm$json$Json$Decode$field, 'quoteText', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'quoteAuthor', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'quoteGenre', $elm$json$Json$Decode$string));
var $author$project$Main$quotesListDecoder = A2(
	$elm$json$Json$Decode$field,
	'data',
	$elm$json$Json$Decode$list($author$project$Main$quoteDecoder));
var $author$project$Main$getRandomQuote = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$GotRandomQuote, $author$project$Main$quotesListDecoder),
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			navbarShadow: false,
			scrolledPastAuthor: false,
			view: $author$project$Main$SingleQuote($author$project$Main$Loading)
		},
		$author$project$Main$getRandomQuote);
};
var $author$project$Main$UserScrolled = function (a) {
	return {$: 'UserScrolled', a: a};
};
var $author$project$Main$scrollTop = _Platform_incomingPort('scrollTop', $elm$json$Json$Decode$int);
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$Main$scrollTop($author$project$Main$UserScrolled);
};
var $author$project$Main$AuthorQuotes = function (a) {
	return {$: 'AuthorQuotes', a: a};
};
var $author$project$Main$Error = {$: 'Error'};
var $author$project$Main$Success = function (a) {
	return {$: 'Success', a: a};
};
var $author$project$Main$GotRandomAuthorQuotes = function (a) {
	return {$: 'GotRandomAuthorQuotes', a: a};
};
var $author$project$Main$getRandomAuthorQuotes = function (author) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Main$GotRandomAuthorQuotes, $author$project$Main$quotesListDecoder),
				...
				if (status.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								view: $author$project$Main$SingleQuote(
									$author$project$Main$Success(message))
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								view: $author$project$Main$SingleQuote($author$project$Main$Error)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'GetAnotherRandomQuote':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
					...
					$author$project$Main$getRandomQuote);
			case 'GetRandomAuthorQuotes':
				var author = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							view: $author$project$Main$AuthorQuotes($author$project$Main$Loading)
						}),
					$author$project$Main$getRandomAuthorQuotes(author));
			case 'GotRandomAuthorQuotes':
				var status = msg.a;
				if (status.$ === 'Ok') {
					var data = status.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								view: $author$project$Main$AuthorQuotes(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								view: $author$project$Main$AuthorQuotes($author$project$Main$Error)
							}),
						$elm$core$Platform$Cmd$none);
				}
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							navbarShadow: (amount > 0) ? true : false,
							scrolledPastAuthor: (amount > 43) ? true : false
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$GetAnotherRandomQuote = {$: 'GetAnotherRandomQuote'};
...
var $icidasset$elm_material_icons$Material$Icons$autorenew = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$d('M12 6v3l4-4-4-4v3c-4.42 0-8 3.58-8 8 0 1.57.46 3.03 1.24 4.26L6.7 14.8c-.45-.83-.7-1.79-.7-2.8 0-3.31 2.69-6 6-6zm6.76 1.74L17.3 9.2c.44.84.7 1.79.7 2.8 0 3.31-2.69 6-6 6v-3l-4 4 4 4v-3c4.42 0 8-3.58 8-8 0-1.57-.46-3.03-1.24-4.26z')
				]),
			_List_Nil)
		]));
...
var $author$project$Main$quoteCard = function (data) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$fromRgb255(
							{alpha: 1, blue: 148, green: 223, red: 247}))
					]),
				...
				_List_fromArray(
					[
						...
						{bottom: 0, left: 90, right: 0, top: 0}),
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('“' + (data.quoteText + '”'))
					]))
			]));
};
var $author$project$Main$GetRandomAuthorQuotes = function (a) {
	return {$: 'GetRandomAuthorQuotes', a: a};
};
var $icidasset$elm_material_icons$Material$Icons$arrow_right_alt = A2(
	$icidasset$elm_material_icons$Material$Icons$Internal$icon,
	_List_fromArray(
		[
			$icidasset$elm_material_icons$Material$Icons$Internal$v('0 0 24 24')
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$d('M16.01 11H4v2h12.01v3L20 12l-3.99-4z')
				]),
			_List_Nil)
		]));
...
var $author$project$Main$quoteFooter = function (data) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$class('quote-footer-more')),
				$mdgriffith$elm_ui$Element$height(
				$mdgriffith$elm_ui$Element$px(151))
			]),
		{
			label: A2(
				$mdgriffith$elm_ui$Element$row,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text(data.quoteAuthor)
									])),
								A2(
								$mdgriffith$elm_ui$Element$paragraph,
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$htmlAttribute(
										$elm$html$Html$Attributes$class('footer-subtitle')),
										$mdgriffith$elm_ui$Element$Font$size(14),
										$mdgriffith$elm_ui$Element$Font$color(
										$mdgriffith$elm_ui$Element$fromRgb255(
											{alpha: 1, blue: 130, green: 130, red: 130}))
									]),
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text(data.quoteGenre)
									]))
							])),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$htmlAttribute(
								$elm$html$Html$Attributes$class('footer-more-arrow'))
							]),
						$mdgriffith$elm_ui$Element$html(
							A2(
								$icidasset$elm_material_icons$Material$Icons$arrow_right_alt,
								32,
								$icidasset$elm_material_icons$Material$Icons$Types$Color(
									A3($avh4$elm_color$Color$rgb, 91, 11, 11)))))
					])),
			onPress: $elm$core$Maybe$Just(
				$author$project$Main$GetRandomAuthorQuotes(data.quoteAuthor))
		});
};
var $author$project$Main$fullQuote = function (data) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Main$quoteCard(data),
				$author$project$Main$quoteFooter(data)
			]));
};
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$htmlAttribute(
							$elm$html$Html$Attributes$class(
								(model.navbarShadow ? 'navbar-shadow' : '') + ' navbar'))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$centerX,
									$mdgriffith$elm_ui$Element$paddingEach(
									{bottom: 0, left: 80, right: 0, top: 0}),
									...
									$mdgriffith$elm_ui$Element$htmlAttribute(
									$elm$html$Html$Attributes$class(
										'navbar-author' + (model.scrolledPastAuthor ? ' navbar-author-visible' : '')))
								]),
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text(
									function () {
										if (model.scrolledPastAuthor) {
											var _v0 = model.view;
											if (_v0.$ === 'SingleQuote') {
												var status = _v0.a;
												if (status.$ === 'Success') {
													var quoteData = status.a;
													var _v2 = $elm$core$List$head(quoteData);
													if (_v2.$ === 'Just') {
														var data = _v2.a;
														return data.quoteAuthor;
													} else {
														return 'No quotes.';
													}
												} else {
												...
												if (status.$ === 'Success') {
													var quoteData = status.a;
													var _v4 = $elm$core$List$head(quoteData);
													if (_v4.$ === 'Just') {
														var data = _v4.a;
														return data.quoteAuthor;
													} else {
								...
								label: A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$mdgriffith$elm_ui$Element$text('random')
												])),
											A2(
											$mdgriffith$elm_ui$Element$el,
											_List_Nil,
											$mdgriffith$elm_ui$Element$html(
												A2(
													$icidasset$elm_material_icons$Material$Icons$autorenew,
													32,
													$icidasset$elm_material_icons$Material$Icons$Types$Color(
														A3($avh4$elm_color$Color$rgb255, 33, 33, 33)))))
										])),
								onPress: $elm$core$Maybe$Just($author$project$Main$GetAnotherRandomQuote)
							})
						])))
			]),
		A2(
				...
				[
					...
					if (_v5.$ === 'SingleQuote') {
						...
						return A2(
							...
							function () {
								switch (status.$) {
									case 'Success':
										var quoteData = status.a;
										return A2($elm$core$List$map, $author$project$Main$fullQuote, quoteData);
									case 'Loading':
										return _List_fromArray(
											[
												A2(
									...
									default:
										return _List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text('An error has occurred')
											]);
								}
							}());
					} else {
						...
						switch (status.$) {
							case 'Success':
								...
								return A2(
									...
									A2(
										...
										A2(
											...
											_List_fromArray(
												[
													...
													$mdgriffith$elm_ui$Element$Font$color(
													$mdgriffith$elm_ui$Element$fromRgb255(
														{alpha: 1, blue: 33, green: 33, red: 33}))
												]),
											_List_fromArray(
												[
													$mdgriffith$elm_ui$Element$text(
													function () {
														var _v8 = $elm$core$List$head(quotesData);
														if (_v8.$ === 'Just') {
															var data = _v8.a;
															return data.quoteAuthor;
														} else {
										...
										A2($elm$core$List$map, $author$project$Main$quoteCard, quotesData)));
							case 'Loading':
								return A2(
									$mdgriffith$elm_ui$Element$column,
									_List_fromArray(
							...
							default:
								return $mdgriffith$elm_ui$Element$text('An error has occurred');
						}
					}
				}()
				])));
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.QuoteResp":{"args":[],"type":"{ quoteText : String.String, quoteAuthor : String.String, quoteGenre : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"GotRandomQuote":["Result.Result Http.Error (List.List Main.QuoteResp)"],"GetAnotherRandomQuote":[],"GetRandomAuthorQuotes":["String.String"],"GotRandomAuthorQuotes":["Result.Result Http.Error (List.List Main.QuoteResp)"],"UserScrolled":["Basics.Int"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
...
},{}]},["A7H4y","4ee1I"], "4ee1I", "parcelRequire8b4a")
